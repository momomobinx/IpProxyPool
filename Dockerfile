...
#    && go get github.com/momomobinx/IpProxyPool
...
ADD https://wget.la/https://github.com/upx/upx/releases/download/v3.96/upx-3.96-amd64_linux.tar.xz /usr/local
RUN apk add --no-cache xz && xz -d -c /usr/local/upx-3.96-amd64_linux.tar.xz | \
